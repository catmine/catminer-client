      ...
      on @machines do
        #as user do
          ...
          unless test '[ -f /etc/systemd/system/catminer-client.service ]'
            ...
            execute 'echo "Requires=network.target" | sudo tee --append /etc/systemd/system/catminer-client.service'
            ...
            execute 'echo "TimeoutSec=30" | sudo tee --append /etc/systemd/system/catminer-client.service'
            execute 'echo "RestartSec=15s" | sudo tee --append /etc/systemd/system/catminer-client.service'
