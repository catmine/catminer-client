module CatminerClient
  class Miners
    ...
    def ewbf_miner
      run_locally do
        execute "wget https://github.com/nanopool/ewbf-miner/releases/download/v0.3.4b/Zec.miner.0.3.4b.Linux.Bin.tar.gz -P #{Dir.pwd}/miners"
        test "mkdir #{Dir.pwd}/vendor/miners/ewbf-miner"
        execute "tar -xvzf #{Dir.pwd}/miners/Zec.miner.0.3.4b.Linux.Bin.tar.gz -C #{Dir.pwd}/vendor/miners/ewbf-miner"
      end
    end
  end
end