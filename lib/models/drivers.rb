module CatminerClient
  class Drivers
    ...
    def amd_pro
      run_locally do
        unless test "[ -d #{Dir.pwd}/vendor/drivers/amdgpu-pro ]"
          unless test "[ -f #{Dir.pwd}/vendor/drivers/amdgpu-pro-18.10-572953.tar.xz ]"
          ...
          execute "cd #{Dir.pwd}/vendor/drivers && tar -Jxvf amdgpu-pro-18.10-572953.tar.xz"
    ...
    def cuda
      run_locally do
        unless test "[ -f #{Dir.pwd}/vendor/drivers/cuda.run ]"
